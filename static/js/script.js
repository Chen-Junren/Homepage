console.log('%cCopyright © 2024 xhsy220506.top', 'background-color: #333333; color: white; font-size: 24px; font-weight: bold; padding: 10px;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function changeTheme(theme) {
        if (theme == "Dark") {
            themeState = "Dark";
            changeSvg("#ffffff");
            tanChiShe.src = "https://raw.githubusercontent.com/Chen-Junren/Chen-Junren/output/github-contribution-grid-snake-dark.svg";
            htmlTag.dataset.theme = 'dack';
        } else if (theme == "Blue") {
            themeState = "Blue";
            changeSvg("#000000");
            tanChiShe.src = "https://raw.githubusercontent.com/Chen-Junren/Chen-Junren/output/github-contribution-grid-snake.svg";
    ...
    var center = document.getElementById("PageLoading-center");
    setTimeout(function () {
        checkProjectItems();
